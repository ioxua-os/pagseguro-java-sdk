...
public class PreApprovalSubscriptionResource {
    ...
    /**
     * Pre Approval Subscription search by code
     *
     * @param code Pre Approval Subscription code. Generated by PreApprovalSubscriptionResource#subscribe()
     * @return Response of pre approval subscription search
     * @see PreApprovalSubscriptionResource#register(PreApprovalSubscription)
     * @see PreApprovalSubscriptionSummary
     */
    public PreApprovalSubscriptionSummary searchByCode(String code) {
        ...
        try {
            ...
            LOGGER.error("Erro ao executar pesquisa de adesão");
            throw new PagSeguroLibException(e);
        }
        LOGGER.info("Parseando XML de resposta");
        PreApprovalSubscriptionSummaryResponseXML cancelledSubscription = response.parseXMLContent(pagSeguro,
                PreApprovalSubscriptionSummaryResponseXML.class);
        LOGGER.info("Parseamento finalizado");
        LOGGER.info("Assinatura pre approval finalizado");
        return cancelledSubscription;
    }
     ...
     *
     * @param code Pre Approval Subscription code. Generated by PreApprovalSubscriptionResource#subscribe()
     * @param preApprovalSubscriptionPaymentMethodUpdateBuilder Builder for Pre Approval Subscription update data
     ...
     */
    public UpdatedPreApprovalSubscription updatePaymentMethod(
            String code,
            Builder<PreApprovalSubscriptionPaymentMethodUpdate> preApprovalSubscriptionPaymentMethodUpdateBuilder) {
        return updatePaymentMethod(code, preApprovalSubscriptionPaymentMethodUpdateBuilder.build());
    }
