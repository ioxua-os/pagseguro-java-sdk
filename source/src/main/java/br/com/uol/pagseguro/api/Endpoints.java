...
public final class Endpoints {
   ...
   */
  public static final String PRE_APPROVALS = "%s/pre-approvals";
   ...
   */
  public static final String PRE_APPROVAL_UPDATE_PAYMENT_METHOD = "%s/pre-approvals/%s/payment-method";
